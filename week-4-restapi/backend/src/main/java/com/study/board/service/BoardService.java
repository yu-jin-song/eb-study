...
public class BoardService {
     ...
     * @return 게시글의 총 개수
     */
    public int getBoardCount(SearchCriteria condition) {
     ...
     */
    public List<BoardDTO> getAllBoards(SearchCriteria condition) {
    ...
    public boolean checkPassword(long boardId, String password) {
        String storedPassword = boardMapper.getPasswordEncryptById(boardId);
        String inputPassword = boardMapper.getPasswordEncrypt(password);
