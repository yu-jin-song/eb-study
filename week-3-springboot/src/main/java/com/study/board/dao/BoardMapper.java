...
public interface BoardMapper {
     ...
     */
    List<BoardDTO> getAllBoards(Condition condition);
    ...
    /**
     * 주어진 조건에 맞는 게시글의 수를 조회합니다.
     *
     * @param condition 게시글 조회 조건
     * @return 조건에 맞는 게시글의 수
     */
    int getBoardCount(Condition condition);
    ...
    /**
     * 특정 게시글의 비밀번호 해시값을 조회
     *
     * @param boardId 게시글 ID
     * @return 비밀번호 해시값
     */
    String getPasswordById(long boardId);
